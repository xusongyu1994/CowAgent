...
<CardGroup cols={2}>
  ...
  <Card title="search_files - 文件搜索" icon="magnifying-glass" href="/zh/tools/search-files">
    搜索文件内容，或按文件名查找文件
  </Card>
  ...
  <Card title="agent_delegate - 委派" icon="users" href="/zh/tools/delegate">
    把任务交给会话中的另一个 Agent
  </Card>
  <Card title="subagent - 子 Agent" icon="users-gear" href="/zh/tools/subagent">
    创建临时的子 Agent 并行执行独立任务
  </Card>
</CardGroup>
